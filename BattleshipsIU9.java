...
public class BattleshipsIU9 {
    ...
    public static void main(String[] args){
        ...
        do {
            Battle();
        }while(BattleshipsIU9.playerShips != 0 && BattleshipsIU9.computerShips != 0);
    ...
    public static void deployPlayerShips(){
        ...
        BattleshipsIU9.playerShips = 5;
        for (int i = 1; i <= BattleshipsIU9.playerShips; ) {
    ...
    public static void deployComputerShips(){
        ...
        BattleshipsIU9.computerShips = 5;
        for (int i = 1; i <= BattleshipsIU9.computerShips; ) {
    ...
    public static void Battle(){
        ...
        System.out.println();
        System.out.println("Your ships: " + BattleshipsIU9.playerShips + " | Computer ships: " + BattleshipsIU9.computerShips);
        System.out.println();
    }
        ...
        do {
            ...
            if ((x >= 0 && x < numRows) && (y >= 0 && y < numCols)) //valid guess
            {
                if (grid[x][y] == "x") //if computer ship is already there; computer loses ship
                {
                    ...
                    grid[x][y] = "!"; //Hit mark
                    --BattleshipsIU9.computerShips;
                }
                else if (grid[x][y] == "@") {
                    System.out.println("Oh no, you sunk your own ship :(");
                    grid[x][y] = "x";
                    --BattleshipsIU9.playerShips;
    ...
    public static void gameOver(){
        System.out.println("Your ships: " + BattleshipsIU9.playerShips + " | Computer ships: " + BattleshipsIU9.computerShips);
        if(BattleshipsIU9.playerShips > 0 && BattleshipsIU9.computerShips <= 0)
